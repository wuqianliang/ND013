...
if __name__ == "__main__":
    ...
    def process_folder_forxuzhen(yolo):
        yolo.process_folder(input_folder="E:/face_detection/dd", output_folder="E:/face_detection/dd/object-detect")
